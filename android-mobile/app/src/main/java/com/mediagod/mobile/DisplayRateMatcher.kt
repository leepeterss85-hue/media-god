...
/**
 * Supplies Android with the content frame-rate hint. Phones/tablets keep the
 * current display resolution and let Android choose the most suitable refresh
 * rate. The optional mode-switch path is available for TV-style builds.
 */
